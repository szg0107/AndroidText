package com.szg.homemakingapplication.maps;
...
public class RoutePlanDemo extends Activity implements BaiduMap.OnMapClickListener,
    ...
    public void searchButtonProcess(View v) {
        ...
        PlanNode stNode = PlanNode.withCityNameAndPlaceName("石家庄", editSt.getText().toString());
        PlanNode enNode = PlanNode.withCityNameAndPlaceName("石家庄", editEn.getText().toString());
        ...
        if (v.getId() == R.id.drive) {
            ...
            mSearch.transitSearch((new TransitRoutePlanOption())
                    .from(stNode).city("石家庄").to(enNode));
