...
import com.zdpractice.xgdemo.cloud.ClickAction;
import com.zdpractice.xgdemo.cloud.Style;
import com.zdpractice.xgdemo.cloud.TimeInterval;
import com.zdpractice.xgdemo.cloud.XingeApp;
import com.zdpractice.xgdemo.common.CommonWorkingThread;
import com.zdpractice.xgdemo.common.ExtendedListView;
import com.zdpractice.xgdemo.common.ExtendedListView.OnPositionChangedListener;
...
public class DiagnosisActivity extends Activity implements OnPositionChangedListener {
	...
	private void step7() {
		...
		int ret_code = 0;
		try {
			com.zdpractice.xgdemo.cloud.Message message = new com.zdpractice.xgdemo.cloud.Message();
			message.setType(com.zdpractice.xgdemo.cloud.Message.TYPE_NOTIFICATION);
