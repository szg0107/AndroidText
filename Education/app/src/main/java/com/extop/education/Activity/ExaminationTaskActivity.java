...
public class ExaminationTaskActivity extends ToolbarWebViewActivity {

    private String url = MyApplication.url+"ksrw.view?taskId=";
...
//        Log.d("时间戳",timestamp+"");
        xWalkView.setUIClient(new XWalkUIClient(xWalkView){
            ...
            public boolean onJsAlert(XWalkView view, String url, String message, XWalkJavascriptResult result) {
                NetWorkTools.dialog(ExaminationTaskActivity.this,message);
                result.cancel();
                return true;
            }
        });
    ...
    public void  testFinished(String message){
        dialog(ExaminationTaskActivity.this,message);
    }
}
