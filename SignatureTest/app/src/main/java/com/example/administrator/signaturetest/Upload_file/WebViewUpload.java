package com.example.administrator.signaturetest.Upload_file;
...
public class WebViewUpload extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.loadUrl("file:///android_asset/shangchuan.html");//调用loadView方法为WebView加入链接
    ...
    private WebChromeClient mWebChromeClient = new WebChromeClient() {
        ...
        public void openFileChooser(ValueCallback<Uri> uploadMsg) {
            ...
            i.setType("image/*");
            WebViewUpload.this.startActivityForResult(Intent.createChooser(i, "Image Chooser"), FILECHOOSER_RESULTCODE);
        ...
        public void openFileChooser(ValueCallback uploadMsg, String acceptType) {
            ...
            i.addCategory(Intent.CATEGORY_OPENABLE);
            i.setType("image/*");
            WebViewUpload.this.startActivityForResult(
        ...
        public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
            ...
            i.addCategory(Intent.CATEGORY_OPENABLE);
            i.setType("image/*");
            WebViewUpload.this.startActivityForResult(Intent.createChooser(i, "Image Chooser"), WebViewUpload.FILECHOOSER_RESULTCODE);
