...
public class DifferentialNotificationTaskActivity extends ToolbarWebViewActivity {
    private String url = MyApplication.url+"cytzlrw.view?taskId=";
...
//        webView.addJavascriptInterface(this,"callByJs");
        xWalkView.setUIClient(new XWalkUIClient(xWalkView){
            ...
            public boolean onJsAlert(XWalkView view, String url, String message, XWalkJavascriptResult result) {
                dialog(DifferentialNotificationTaskActivity.this,message);
                result.cancel();
                return true;
            }
        });
