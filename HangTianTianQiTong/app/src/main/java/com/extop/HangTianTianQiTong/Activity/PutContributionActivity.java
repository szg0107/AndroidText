...
public class PutContributionActivity extends ToolbarWebViewActivity {
    private String url = MyApplication.url+"putContribution.view?id=";
    ...
    final Handler hand = new Handler()
    {
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what == 123)
            {
                ...
                pd.dismiss();
                Toast toast = Toast.makeText(PutContributionActivity.this, "上传成功！", Toast.LENGTH_LONG);
                toast.show();
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tw_title.setText("发布贡献");
        xWalkView.loadUrl(url+ MyApplication.circleID+"&reuse="+intent.getStringExtra("reuse"));
        Log.d("贡献URL",url+ MyApplication.circleID+"&reuse="+intent.getStringExtra("reuse"));
        xWalkView.setUIClient(new UIClient(xWalkView));
        pd = new ProgressDialog(PutContributionActivity.this);
    ...
    protected void dialog(String message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(PutContributionActivity.this, R.style.AlertDialog);
