...
import com.extop.HangTianTianQiTong.Receiver.MyReceiver;
...
//                    File file= new File(fileName);
            Uri apkUri = FileProvider.getUriForFile(this, "com.extop.HangTianTianQiTong.pro.fileprovider", file);//在AndroidManifest中的android:authorities值
