...
public class AuditTaskActivity extends ToolbarWebViewActivity {
    private String url = MyApplication.url+"shrw.view?taskId=";
    @Override
...
//        Log.d("时间戳",timestamp+"");
        xWalkView.setUIClient(new XWalkUIClient(xWalkView){
            ...
            public boolean onJsAlert(XWalkView view, String url, String message, XWalkJavascriptResult result) {
                dialog(AuditTaskActivity.this,message);
                result.cancel();
                return true;
            }
        });
